...
def print_compound_interest (principal, rate, time):
...
def calculateCompoundInterest():
    ...
    print_compound_interest(client_principal_1, client_rate_1, client_time_1)
    print(line_break)

    client_principal_2, client_time_2, client_rate_2 = collect_inputs_and_convert_to_float()
    print_compound_interest(client_principal_2, client_rate_2, client_time_2)
    print(line_break)

    client_principal_3, client_time_3, client_rate_3 = collect_inputs_and_convert_to_float()
    print_compound_interest(client_principal_3, client_rate_3, client_time_3)
